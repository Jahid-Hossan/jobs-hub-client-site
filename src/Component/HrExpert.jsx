                    ...
                    <div className="lg:gap-xl-12 grid gap-x-6 md:grid-cols-3 xl:grid-cols-4">
                        <div className="mb-12">
                            <img src="https://mdbcdn.b-cdn.net/img/new/avatars/2.jpg"
                                className="mx-auto w-[200px]  mb-4 rounded-full shadow-lg dark:shadow-black/20" alt="" />

                            <p className="mb-2 font-bold">John Doe</p>
                            <p className="text-neutral-500 dark:text-neutral-300">Cv-Expert</p>
                        </div>
                        ...
                        <div className="mb-12">
                            ...
                            <p className="text-neutral-500 dark:text-neutral-300">UX Designer</p>
                        </div>
